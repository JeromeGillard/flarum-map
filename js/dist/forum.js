...
function getMapConfig(o_tilesProvider, o_style, o_zoom) {
  ...
  switch (tilesProvider) {
    case "mapbox":
      ...
      currentStyle = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute("mapbox.style") || 'mapbox/light-v9';
    ...
    case "thunderforest":
      ...
      currentStyle = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute("thunderforest.style") || 'atlas';
    ...
    case "maptiler":
      ...
      currentStyle = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().forum.attribute("maptiler.style") || 'basic-v2';
...
function createMap(pid) {
  ...
  so.mapConf = getMapConfig(); // copy this for usage within .each()
  //let so = this;
  ...
  $('.bbcode-map').each(function (i) {
    ...
    var mapConf = getMapConfig($(this).data('mapProvider'), $(this).data('mapStyle'), $(this).data('mapZoom'));
...
(0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_3__.extend)((flarum_components_Page__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'oncreate', function () {
  ...
  if (this.attrs.routeName == 'page') {
    ...
    (0,_components_mapConfigHelper__WEBPACK_IMPORTED_MODULE_8__.createMap)(this.attrs.id);
  }
});
(0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_3__.extend)((flarum_components_Post__WEBPACK_IMPORTED_MODULE_1___default().prototype), 'oncreate', function () {
  ...
  (0,_components_mapConfigHelper__WEBPACK_IMPORTED_MODULE_8__.createMap)(this.pid);
});
